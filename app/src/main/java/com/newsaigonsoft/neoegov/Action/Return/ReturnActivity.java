...
public class ReturnActivity extends ReturnBase implements ReturnView {

    @BindView(R.id.list_returner)
    ...
    @BindView(R.id.cancel_forward)
    TextView btnCancel;
    @BindView(R.id.attach_list)
    NonScrollListView lvAttach;

    @Optional
    @OnClick({R.id.button_forward, notify_layout, R.id.cancel_forward, R.id.choose_file})
    public void onClick(View v) {
        int id = v.getId();
        switch (id) {
            case R.id.button_forward:
                showProgressDialog("", this, DIALOG_CENTER, true);
                mReturnLogic.RequestReturn(ArrayFileAttach());
                break;
            case notify_layout:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_return_document);
        ...
        mReturnLogic = new ReturnLogic(this, this);
        mReturnLogic.getListPerson(DocumentID);
    }
...
//                    String filename = uri.getLastPathSegment();
                    ...
                    lvAttach.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            checkRunTimePermission(position, arrFileAttach, ReturnActivity.this);
                        }
                    });
                }
                break;
    ...
    public JSONArray ArrayFileAttach() {
    ...
    @Override
    public void setListReturn(ReturnDocumentAdapter adapter) {
...
//            return readFromFile(ReturnActivity.this, "return_list" + DocumentID);
//        }
//
//        @Override
...
//                }
//                ReturnDocumentAdapter adapter = new ReturnDocumentAdapter(ReturnActivity.this, arrayList);
//                lv.setAdapter(adapter);
//            } catch (JSONException e) {
//
//                e.printStackTrace();
...
//    }
//
    //    private String addJsonRequestReturn() {
//        JSONObject mJsonObject = new JSONObject();
//        try {
...
//    }
//
//    class Return extends AsyncTask<String, Integer, String> {
//
//        @Override
//        protected String doInBackground(String... params) {
//            JSONObject mJsonObject = new JSONObject();
...
//            return eventPostRequest(getModuleInfor(PROCESSING_WORKING, ReturnActivity.this), mJsonObject.toString(), getUserid(), getPass());
//        }
//
//        @Override
//        protected void onPostExecute(String s) {
...
//                Intent intent = new Intent(ReturnActivity.this, OfficalActivity.class);
...
//                closeProgressDialog();
//            } catch (JSONException e) {
//                ShowErrorToast(ReturnActivity.this);
//                e.printStackTrace();
//            }
//            super.onPostExecute(s);
//        }
...
//        lv = (NonScrollListView) findViewById(R.id.list_returner);
...
////                    }
////                }
//                //                new NeoTask(this, this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new CaseManager(this, ACTION_RETURN, addJsonRequestReturn(), getLink() + URL_CENTER_6_1));
////                new Return().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, getLink() + URL_CENTER_6_1);
//                mReturnLogic.RequestReturn(ArrayFileAttach());
//
//                break;
//            case notify_layout:
