...
public class StatisticalDPMTotalAdapter extends BaseAdapter {
    ...
    public StatisticalDPMTotalAdapter(Context context, List<StatisticalDPMRow> object) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view != null) {
            ...
            view = inflater.inflate(R.layout.custom_statistical_department_total_row, null);
        ...
        mViewHolder.tvDepartment.setText(object.get(i).getName());
        ...
        mViewHolder.tvParty.setText(String.valueOf(object.get(i).getProcessCoordinate()));
    ...
    class ViewHolder {
        @BindView(R.id.dpm_row_name)
        TextView tvName;
        @BindView(R.id.st_dpm_row_ontime)
        TextView tvOnTime;
        @BindView(R.id.st_dpm_party)
        TextView tvParty;
        @BindView(R.id.st_dpm_row_delays)
        TextView tvDelays;
        @BindView(R.id.st_dpm_row_indue)
        TextView tvIndue;
        @BindView(R.id.st_dpm_row_out_of_date)
        ...
        @Optional
        @OnClick({R.id.st_dpm_row_ontime, R.id.st_dpm_row_delays, R.id.st_dpm_row_indue, R.id.st_dpm_row_out_of_date, R.id.st_dpm_party})
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                case R.id.st_dpm_row_ontime:
                    ...
                    break;
                case R.id.st_dpm_row_delays:
                    ((OfficalActivity) context).setLookupScreen(TAP_DPM_DELAYS);
                    ((OfficalActivity) context).mOfficeLogic.eventGetHomeListDocument(
                            SumManager.LimitPager
                            , TAP_DPM_DELAYS,
                            object.get(position).getProcessedDemurrageType(), object.get(position).getObjectId());
                    break;
                case R.id.st_dpm_row_indue:
                    ...
                    break;
                case R.id.st_dpm_row_out_of_date:
                    ((OfficalActivity) context).setLookupScreen(TAP_DPM_OUT_OF_DATE);
                    ((OfficalActivity) context).mOfficeLogic.eventGetHomeListDocument(
                            SumManager.LimitPager
                            , TAP_DPM_OUT_OF_DATE,
                            object.get(position).getProcessDemurrageType(), object.get(position).getObjectId());
                    break;
                case R.id.st_dpm_party:
                    ((OfficalActivity) context).setLookupScreen(TAP_DPM_ONTIME);
                    ((OfficalActivity) context).mOfficeLogic.eventGetHomeListDocument(
                            SumManager.LimitPager
                            , TAP_DPM_ONTIME,
                            object.get(position).getProcessCoordinateType(), object.get(position).getObjectId());
                    break;
                default:
                    break;
            }
